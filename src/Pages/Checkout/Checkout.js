                            ...
                            <div x-show="card">
                                <div className="space-y-4">
                                    <div>
                                        ...
                                        <input
                                            id="card-nr"
                                            className="w-full rounded border border-gray-200 bg-white py-2 px-3 text-sm leading-5 text-gray-800 placeholder-gray-400 shadow-sm hover:border-gray-300 focus:border-sky-300 focus:ring-0"
                                            type="text"
                                ...
                                <div className="mt-6">
                                    <div className="mb-4">
                                        <button className="inline-flex w-full items-center justify-center rounded border border-transparent bg-sky-500 px-3 py-2 text-sm font-medium leading-5 text-white shadow-sm transition duration-150 ease-in-out hover:bg-sky-600 focus:outline-none focus-visible:ring-2">
                                            Book now
                                        </button>
                                    </div>
                                </div>
