            ...
            <div className="mx-auto w-11/12 md:w-3/4 lg:w-[600px]">
                <div className="group relative z-0 mb-6 w-full">
                    <input
                        type="text"
                        name="floating_email"
                        className="text-md peer block w-full appearance-none border-0 border-b-2 border-gray-300 bg-transparent py-2.5  px-0 text-gray-900 focus:border-blue-600 focus:outline-none focus:ring-0 dark:border-gray-600 dark:text-white dark:focus:border-blue-500"
                        placeholder=" "
                        required
